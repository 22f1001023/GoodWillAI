        ...
        <div class="col-lg-6 d-flex align-items-center justify-content-center">
          <div class="card p-4 bg-black text-light shadow-lg" style="width: 100%; max-width: 410px; border-radius: 18px; border: 1px solid #222;">
            <div class="text-center mb-3">
              <i class="fa-solid fa-robot fa-2x mb-2" style="color: #00ffe0;"></i>
            ...
            <form @submit.prevent="login" autocomplete="off">
              <div class="mb-3">
                ...
                <input type="email" class="form-control bg-dark text-light border-0 border-bottom" id="email" v-model="email" placeholder="Enter your email" required autofocus>
              </div>
              <div class="mb-3">
                <label for="password" class="form-label text-muted">Password</label>
                <input type="password" class="form-control bg-dark text-light border-0 border-bottom" id="password" v-model="password" placeholder="Enter your password" required>
              </div>
